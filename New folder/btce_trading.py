...
def strategyone():
    ...
    VU = float(btcusdbids[0][1])
    logger1.info(VU)
    VU /= (float(ppcbtcasks[0][0]))  # I do this so that all the volume is in ppc
    ...
    if finalusd > cost:
        def do_trade():
            ...
            loggerstrat2.info("z.received" + str(z.received))
            loggerstrat2.info("z.remains" + str(z.remains))

            loggerstrat2.info("doing second trade")
            y = trader.trade(pair2[:3] + '_' + pair2[3:], 'sell', float(eval(pair2 + 'bids[0][0]')), amtlitecoin)
            loggerstrat2.info("y.received" + str(y.received))
            loggerstrat2.info("y.remains" + str(y.remains))
            ...
            loggerstrat2.info("w.received" + str(w.received))
            loggerstrat2.info("w.remains" + str(w.remains))
    ...
    if finalusd > cost:
        def do_trade():
            ...
            loggerstrat2.info("doing last trade")
            w = trader.trade(pair4[:3] + '_' + pair4[3:], 'sell', float(eval(pair4 + 'bids[0][0]')), amtnvccoin)
            loggerstrat2.info("z.received" + str(w.received))
            loggerstrat2.info("z.remains" + str(w.remains))
    ...
    loggerstrat2.info(" VALID_PATH :  ['USD', 'BTC', 'RUR', ‘LTC’,’USD’]")
    pair1 = "btcusd"
    pair2 = "btcrur"
    pair3 = "ltcrur"
    pair4 = "ltcusd"
    ...
    if finalusd > cost:
        def do_trade():
            ...
            z = trader.trade(pair1[:3] + '_' + pair1[3:], 'buy', float(eval(pair1 + 'asks[0][0]')), maxv)
            loggerstrat9.info("z.received " + str(z.received))
            loggerstrat9.info("z.remains " + str(z.remains))

            loggerstrat9.info("doing second trade")
            y = trader.trade(pair2[:3] + '_' + pair2[3:], 'sell', float(eval(pair2 + 'bids[0][0]')), amtlitecoin)
            loggerstrat9.info("y.received " + str(y.received))
            loggerstrat9.info("y.remains " + str(y.remains))
            ...
            loggerstrat9.info("w.received " + str(w.received))
            loggerstrat9.info("w.remains " + str(w.remains))

            loggerstrat9.info("doing last trade")
            v = trader.trade(pair5[:3] + '_' + pair5[3:], 'sell', float(eval(pair5 + 'bids[0][0]')), amtdickcoin)
            loggerstrat9.info("v.received " + str(v.received))
            loggerstrat9.info("v.remains " + str(v.remains))
